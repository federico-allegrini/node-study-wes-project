...
const expressValidator = require("express-validator"); // Add methods in req object for work with requests
...
app.use(bodyParser.urlencoded({ extended: true })); // Make possible to read location[address] as location.address
